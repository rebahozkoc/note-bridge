...
/**
 * This class is used to test the PostDao class.
 */
...
class PostDaoTest {
    ...
    /**
     * This method is used to test the retrieval of a post.
     */
    @Test
    @Order(4)
    ...
    /**
     * This method is used to test the update of a post.
     */
    @Test
    @Order(5)
    ...
    /**
     * This method is used to test the retrieval of posts.
     */
    @Test
    @Order(6)
    public void stage6_testGetPosts() {
        ...
        List<PostDto> returnedPosts = PostDao.INSTANCE.getPosts(5, 1, null, 0, null, null, null, null,null);
    ...
    /**
     * This method is used to test the retrieval of posts of a user.
     */
    @Test
    @Order(7)
    public void stage7_testGetMyPosts() {
        ...
        List<PostDto> returnedPosts = PostDao.INSTANCE.getPosts(5, 1, null, person.getId(), null, null, null,null, null);
    ...
    /**
     * This method is used to test the toggle like method of the PostDao class.
     */
    @Test
    @Order(8)
    ...
    /**
     * This method is used to test the total posts method of the PostDao class.
     */
    @Test
    @Order(9)
    ...
    /**
     * This method is used to test the deletion of a post.
     */
    @Test
    @Order(10)
